    ...
    <>
      ...
      <aside
        className={cn(
          ...
          "fixed inset-y-0 left-0 z-40 flex h-full w-64 flex-col border-r border-none bg-[#2ecc71] text-white",
      ...
      >
        ...
        <div className="flex h-14 shrink-0 items-center justify-between gap-2 border-b border-white/20 px-4">
          <Link href="/dashboard" className="flex items-center gap-2">
            <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-white text-[#2ecc71]">
